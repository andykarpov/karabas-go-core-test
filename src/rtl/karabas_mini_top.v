...
--
-- FPGA Test core for Karabas-Go Mini
--
...
dac dac_l(
	.I_CLK(clk100),
	.I_RESET(~clocks_ready),
	.I_DATA({2'b00, !audio_out_l[15], audio_out_l[14:4], 2'b00}),
	.O_DAC(AUDIO_L)
);
...
dac dac_r(
	.I_CLK(clk100),
	.I_RESET(~clocks_ready),
	.I_DATA({2'b00, !audio_out_r[15], audio_out_r[14:4], 2'b00}),
	.O_DAC(AUDIO_R)
);
